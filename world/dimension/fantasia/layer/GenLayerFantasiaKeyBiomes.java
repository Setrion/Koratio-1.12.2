 ...
 * @author Ben
 */
public class GenLayerFantasiaKeyBiomes extends GenLayer {

	public GenLayerFantasiaKeyBiomes(long l, GenLayer genlayer) {
		super(l);
		parent = genlayer;
	}

	public GenLayerFantasiaKeyBiomes(long l) {
		super(l);
	}
	...
	private int getKeyBiomeFor(int mapX, int mapZ, int index) {
		...
		switch ((index + offset) % 2) {
			case 0:
			default:
				return Biome.getIdForBiome(ModBiomes.FANTASIA_SPIKED);
			case 1:
				return Biome.getIdForBiome(ModBiomes.FANTASIA_SPIKED);
		}
	}
