 ...
 */
public class FantasiaBiomeCache {

	private final Long2ObjectMap<Entry> entryMap = new Long2ObjectOpenHashMap<>();
	private final List<Entry> entries = new ArrayList<>();
	private final FantasiaBiomeProvider provider;
	private final int gridSize;
	private final boolean offset;
	private long lastCleanupTime;

	public FantasiaBiomeCache(FantasiaBiomeProvider provider, int gridSize, boolean offset) {
