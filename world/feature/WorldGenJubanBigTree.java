...
import com.setrion.koratio.blocks.BlockLog;
import com.setrion.koratio.blocks.ModBlocks;

public class WorldGenJubanBigTree extends WorldGenAbstractTree
{
    private Random rand;
    private World world;
    ...
    List<WorldGenJubanBigTree.FoliageCoordinates> foliageCoords;

    public WorldGenJubanBigTree(boolean notify)
    {
        super(notify);
    }
    ...
    void generateLeafNodeList()
    {
        ...
        this.foliageCoords = Lists.<WorldGenJubanBigTree.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenJubanBigTree.FoliageCoordinates(this.basePos.up(k), j));
            ...
            if (f >= 0.0F)
            {
                for (int l = 0; l < i; ++l)
                {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1)
                    {
                        ...
                        {
                            this.foliageCoords.add(new WorldGenJubanBigTree.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
    ...
    void generateLeafNode(BlockPos pos)
    {
        ...
        {
            this.crosSection(pos.up(i), this.leafSize(i), ModBlocks.blockJubanLeaves.getDefaultState().withProperty(ModBlocks.blockJubanLeaves.CHECK_DECAY, Boolean.valueOf(false)));
        }
    }
    ...
    void generateLeaves()
    {
        for (WorldGenJubanBigTree.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
    ...
    void generateTrunk()
    {
        ...
        Block block = ModBlocks.blockJubanLog;
    ...
    void generateLeafNodeBases()
    {
        for (WorldGenJubanBigTree.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords)
        {
            ...
            {
                this.limb(blockpos, worldgenbigtree$foliagecoordinates, ModBlocks.blockJubanLog);
            }
        }
    }
    ...
    private boolean validTreeLocation()
    {
        ...
        boolean isSoil = state.getBlock().canSustainPlant(state, this.world, down, net.minecraft.util.EnumFacing.UP, (ModBlocks.blockJubanSapling));
